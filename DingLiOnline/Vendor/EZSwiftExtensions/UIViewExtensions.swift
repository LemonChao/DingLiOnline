...
extension UIView {
    ...
    ///
    /// - Parameters:
    ///   - offset: shadow's offset, width: positice value occur right offset.height: positice value occur bottom offset
    ///   - radius: The blur radius used to create the shadow. Defaults to 3. Animatable.
    ///   - color: The color of the shadow. Defaults to opaque black. Colors created from patterns are currently NOT supported. Animatable.
    ///   - opacity: The opacity of the shadow. Defaults to 0. Specifying a value outside the [0,1] range will give undefined results. Animatable.
    ///   - cornerRadius: When positive, the background of the layer will be drawn with rounded corners. Also effects the mask generated by the `masksToBounds' property. Defaults to zero. Animatable.
