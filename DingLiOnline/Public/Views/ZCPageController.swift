//
//  ZCPageController.swift
//  DingLiOnline
//
//  Created by zchao on 2019/9/6.
...
class ZCPageController: ZCBaseViewController {

    var pageStyle: ZCPageStyle!
    
    lazy var segment: HMSegmentedControl = {
        let view = HMSegmentedControl()
        view.addTarget(self, action: #selector(changeIndex(segment:)), for: .valueChanged)
        return view
    }()
    ...
    convenience init(titles: [String] = [], vcs: [UIViewController] = [], pageStyle: ZCPageStyle = .none) {
        self.init()
        self.titles = titles
        self.vcs = vcs
    ...
    override func configViews() {
        ...
        case .navgationBarSegment?:
            ...
            pageVC.view.snp.makeConstraints { $0.edges.equalToSuperview() }
        case .topTabBar?:
            segment.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(r: 51, g: 51, b: 51),
                                           NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
            segment.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(r: 252, g: 94, b: 98),
                                                   NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
            segment.selectionIndicatorLocation = .down
            segment.selectionIndicatorColor = UIColor(r: 252, g: 94, b: 98)
...
extension ZCPageController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
